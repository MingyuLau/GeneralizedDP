...
class ManiskillCfg:
    obs_mode = "pointcloud"
    traj_json_path = "/mnt/inspurfs/eb3d_t/liumingyu/zzdata/ManiSkill_Demonstrations/demos/StackCube-v1/motionplanning/trajectory.json"
    ...
    traj_path = "/mnt/petrelfs/liumingyu/code/3D-Diffusion-Policy/data/data_maniskill/maniskill_StackCube-v1_expert.zarr"
